...
namespace MagellanMock
{
   ...
   {
      private static string[] crnlToken = new string[] { "\r\n" };

      private static int NextMATNumber = 123456789;
      ...
      private static string GenerateNextMATNumber()
      {
         return GetString(9, "R", "0", (++NextMATNumber).ToString());
      }

      private static string GetString(int width, string justify, string pad, string input)
      {
         string output = "";
      ...
      private Dictionary<string, string> GetFieldMap(string definitionDocXml, string line)
      {
